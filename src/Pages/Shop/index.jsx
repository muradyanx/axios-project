...
export const ApiUrl = 'https://crudcrud.com/api/f41399a5a660480aac183591bcc5e908/';
...
////////////////////
    ...
    const getProductsList = async ()=>{
            const result = await axios.get(`${ApiUrl}productList`)
            if(result.data){
    ...
    return <div>
        ...
        <div className='products-iamges-section'>
            ...
            <div className='product-title-section'>
                    ...
                    {items.map((el) => {
                            return <div key={el._id} className='product-item'>
                                <div className='image' style={{ backgroundImage: `url('${el.productImage}')` }}>
                                    <div className='img-hover'>
                                        <span
                                            className="icon-liked icon-heart"
                                            onClick={likedItems}
                                ...
                                <Link to='/zay-shop'>  <p className='title'>{el.productName}</p> </Link>
